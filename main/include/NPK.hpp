...
public:
    ...
    static constexpr MeasurementEntry MEASUREMENT_TABLE[] = {
        { MeasurementType::Nitrogen,    NITROGEN,       READ_NITROGEN,      PACKET_SIZE },
        { MeasurementType::Moisture,    MOISTURE,       READ_HUMIDITY,      PACKET_SIZE },
        { MeasurementType::PH,          PH,             READ_PH,            PACKET_SIZE },
        { MeasurementType::Phosphorus,  PHOSPHORUS,     READ_PHOSPHORUS,    PACKET_SIZE },
        { MeasurementType::Potassium,   POTASSIUM,      READ_POTASSIUM,     PACKET_SIZE },
        { MeasurementType::Temperature, TEMPERATURE,    READ_TEMPERATURE,   PACKET_SIZE }
    };
